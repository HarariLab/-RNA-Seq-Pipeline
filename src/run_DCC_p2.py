...
if (end == "PE"):
    ...
    cmd = '/usr/bin/time -v DCC @' +os.path.join(storage_dcc_in)+'/samplesheet -mt1 @' +os.path.join(storage_dcc_in)+'/mate1 -mt2 @'+os.path.join(storage_dcc_in)+'/mate2 -T 2 -D -R ' +repeat_mask +' -an '+annot +' -Pi -F -M -Nr 1 1 -fg -k -G -A ' +ref+' -B @'+os.path.join(storage_dcc_in)+'/bam_files ' +'-O '+os.path.join(storage_dcc) +' -t ' +os.path.join(storage_tmp)
