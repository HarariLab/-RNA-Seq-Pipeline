...
if args.software_path:
    ...
    cmd = '/opt/salmon-latest_linux_x86_64/bin/salmon quant'
    #cmd = '/usr/local/genome/bin/salmon quant'
...
## extract level 1 genes/transcripts 
cmd2 = 'Rscript /src/filter_salmon_res.r '+args.output_dir+' '+args.annot
